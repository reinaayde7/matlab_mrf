...
function [dict,r] = Calculate_MRF_FISP_DictwithDelays(rawdatafilename,rawinfo,t1series,t2series,b1map,TEtxtfile,TRtxtfile,FAtxtfile,PHtxtfile,Inv,Delays,dephase)
...
%     repeats = 3;
% end
r = paramTable(t1series,t2series,b1map); % stores T1 in first column, T2 in second column
cnt = size(r,1);
if isempty(rawinfo)
