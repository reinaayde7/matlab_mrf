...
RawData.folder = 'E:\scanner_data\twix_data\250410\'; %P2
...
if isTRUEFISP
    ...
    %250410
    RawData.name = 'meas_MID01969_FID13642_rr_MRF_f300m300_48_debug.dat'; % P2, FA15, Nex600, wait1500
...
dictionary_name = 'dict_FISP_TE1_8_TR14_FAbody15_Nex600_SVD';
...
delta_x = -104; %read [mm] - vertical offset with images convention in matlab (- moves up, + moves down)
delta_y = +56; %phase [mm] - horizonatl offset with images convention in matlab (- moves left, + moves right)
...
if lowrank_SVD
    ...
    close(f); time = toc; SVD_comp_time = time2clock(time);
    raw = rawsvd;
...
Folder = 'FISP\';
what = 'Brain_P2_250410';
% what = 'NIST_T2L_250328';
% what = 'Brain_P1_250307_tilt';
extraN = 'f300_Nex600_FA15_wait1500';
if ~PartialFourier
    tmp = flip(transformKspaceToImage(raw_orig,3),3);
else
    tmp = transformKspaceToImage(rawd_o,3);
end
for nn=20%1:TotalSlices
...
%% LLR settings
addpath(genpath('E:\POSTDOC_UoM\08_Project_MRF\CardiacMRF_2D-main\Reconstruction Code\Gridding'));
addpath(genpath('E:\POSTDOC_UoM\08_Project_MRF\CardiacMRF_2D-main\Reconstruction Code\Dictionary\LowRankRecon'));
addpath(genpath('E:\POSTDOC_UoM\08_Project_MRF\CardiacMRF_2D-main\Reconstruction Code\Miscellaneous'));
...
save([RawData.folder tempfilename], 'image_combined_3D', 't1map3d', 't2map3d', 'm0map3d', 'b0map3d', ...
...
addpath('E:\POSTDOC_UoM\08_Project_MRF\3D_MRF_FISP_Prostate-main_d240531\PCAtensordenoiser');
tic
if singleSliceFit    
