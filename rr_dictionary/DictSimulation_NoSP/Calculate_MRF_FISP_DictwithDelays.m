...
function [dict,r] = Calculate_MRF_FISP_DictwithDelays(rawdatafilename,rawinfo,t1series,t2series,offres,TEtxtfile,TRtxtfile,FAtxtfile,PHtxtfile,Inv,Delays,dephase)
...
parfor ipool = 1:poolsize
    ...
    %Rudy: this is the one for debug
