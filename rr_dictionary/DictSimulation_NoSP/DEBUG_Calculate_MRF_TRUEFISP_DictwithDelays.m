...
function [dict,r] = DEBUG_Calculate_MRF_TRUEFISP_DictwithDelays(rawinfo,t1series,t2series,offres,TEtxtfile,TRtxtfile,FAtxtfile,PHtxtfile,Inv,Delays,dephase)
...
%------------------------------------------------------------------------
% [dictr,dicti,dictz] =dictionary_TRUEFISP_withRelaxDecay_opt(...
...
% pi_v = zeros(size(dict));
% for i = 2:2:Nex
%     pi_v(i,:,:) = pi;
% end
% dict = dict.*exp(-j*pi_v);
