...
//
// dictionary_TRUEFISP_withRelaxDecay_opt.cpp
//
// Code generation for function 'dictionary_TRUEFISP_withRelaxDecay_opt'
//

// Include files
#include "dictionary_TRUEFISP_withRelaxDecay_opt.h"
#include "assertValidSizeArg.h"
#include "dictionary_TRUEFISP_withRelaxDecay_opt_data.h"
...
static emlrtRSInfo emlrtRSI{
    21,                                       // lineNo
    "dictionary_TRUEFISP_withRelaxDecay_opt", // fcnName
...
static emlrtRTEInfo emlrtRTEI{
    23,                                       // lineNo
    9,                                        // colNo
    "dictionary_TRUEFISP_withRelaxDecay_opt", // fName
    "E:\\POSTDOC_UoM\\08_Project_MRF\\3D_MRF_FISP_Prostate-main_d240531\\rr_"
    "dictionary\\DictSimulation_NoSP\\dictionary_TRUEFISP_with"
    "RelaxDecay_opt.m" // pName
};
                 ...
                 const coder::array<real_T, 2U> &in3)
{
  ...
  int32_T stride_0_1;
  int32_T stride_1_1;
  in1.set_size(&v_emlrtRTEI, &sp, 3, in1.size(1));
  if (in3.size(1) == 1) {
    loop_ub = in2.size(1);
  } else {
    loop_ub = in3.size(1);
  }
  in1.set_size(&v_emlrtRTEI, &sp, in1.size(0), loop_ub);
                 ...
                 const coder::array<real_T, 2U> &in2)
{
  ...
  b_in1.set_size(&bb_emlrtRTEI, &sp, 3, loop_ub);
  ...
  in1.set_size(&bb_emlrtRTEI, &sp, 3, in1.size(1));
  loop_ub = b_in1.size(1);
  in1.set_size(&bb_emlrtRTEI, &sp, in1.size(0), b_in1.size(1));
  for (int32_T i{0}; i < loop_ub; i++) {
    in1[3 * i] = b_in1[3 * i];
    ...
    coder::array<real32_T, 2U> &My, coder::array<real32_T, 2U> &Mz)
{
  ...
  i = r.size(0);
  Mx.set_size(&f_emlrtRTEI, sp, static_cast<int32_T>(nt), r.size(0));
  if (nt != E1) {
  ...
  My.set_size(&g_emlrtRTEI, sp, static_cast<int32_T>(nt), r.size(0));
  for (i1 = 0; i1 < ibtile; i1++) {
    My[i1] = 0.0F;
  }
  Mz.set_size(&h_emlrtRTEI, sp, static_cast<int32_T>(nt), r.size(0));
  for (i1 = 0; i1 < ibtile; i1++) {
    Mz[i1] = 0.0F;
  }
  ...
  if (b) {
    ...
    phirange.set_size(&j_emlrtRTEI, &st, 1, 0);
  } else {
    E1 = muDoubleScalarFloor(spins);
    i1 = static_cast<int32_T>(E1);
    phirange.set_size(&i_emlrtRTEI, &st, 1, i1);
  ...
  Z.set_size(&k_emlrtRTEI, sp, 3, 3, Z.size(2));
  if (b) {
  ...
  Z.set_size(&k_emlrtRTEI, sp, Z.size(0), Z.size(1),
  ...
  for (ibtile = 0; ibtile < loop_ub; ibtile++) {
    ...
    if ((static_cast<int32_T>(static_cast<uint32_T>(ibtile) + 1U) < 1) ||
      ...
      emlrtDynamicBoundsCheckR2012b(
          ...
          Z.size(2), &d_emlrtBCI, (emlrtConstCTX)sp);
    }
    Z[9 * ibtile] = b_Rz_tmp;
    Z[9 * ibtile + 3] = -Rz_tmp;
    Z[9 * ibtile + 6] = 0.0;
  ...
  for (int32_T n{0}; n < i; n++) {
    ...
    // Rudy debug
    if (n + 1 > i) {
      emlrtDynamicBoundsCheckR2012b(n + 1, 1, i, &f_emlrtBCI,
                                    (emlrtConstCTX)sp);
    }
    T1 = r[n] / 1000.0;
    if (n + 1 > i) {
      emlrtDynamicBoundsCheckR2012b(n + 1, 1, i, &g_emlrtBCI,
                                    (emlrtConstCTX)sp);
    }
    T2 = r[n + r.size(0)] / 1000.0;
    if (n + 1 > i) {
      emlrtDynamicBoundsCheckR2012b(n + 1, 1, i, &h_emlrtBCI,
                                    (emlrtConstCTX)sp);
    }
    df = r[n + r.size(0) * 2];
    st.site = &b_emlrtRSI;
    ...
    M0.set_size(&l_emlrtRTEI, &st, 3, outsize_idx_1);
    ...
    b_st.site = &m_emlrtRSI;
    coder::internal::assertValidSizeArg(b_st, spins);
    M.set_size(&l_emlrtRTEI, &st, 3, b_outsize_idx_1);
    b_st.site = &n_emlrtRSI;
    if (b_overflow) {
      c_st.site = &o_emlrtRSI;
      coder::check_forloop_overflow_error(c_st);
    ...
    for (int32_T iEcho{0}; iEcho < 2; iEcho++) {
      ...
      for (int32_T k{0}; k < i2; k++) {
        ...
        if (k + 1 == 1) {
          ...
          for (ibtile = 0; ibtile < loop_ub; ibtile++) {
            ...
            if ((static_cast<int32_T>(static_cast<uint32_T>(ibtile) + 1U) <
              ...
              emlrtDynamicBoundsCheckR2012b(
                  static_cast<int32_T>(static_cast<uint32_T>(ibtile) + 1U), 1,
                  M.size(1), &e_emlrtBCI, (emlrtConstCTX)sp);
            }
            for (i1 = 0; i1 < 3; i1++) {
        ...
        st.site = &f_emlrtRSI;
        if (k + 1 > flip.size(0)) {
          emlrtDynamicBoundsCheckR2012b(k + 1, 1, flip.size(0), &i_emlrtBCI,
                                        &st);
        }
        if (k + 1 > phase.size(0)) {
          emlrtDynamicBoundsCheckR2012b(k + 1, 1, phase.size(0), &j_emlrtBCI,
                                        &st);
        }
        b_st.site = &f_emlrtRSI;
        throt(b_st, flip[k], phase[k], a);
        Bti.set_size(&o_emlrtRTEI, &st, 3, M.size(1));
        ...
        nt = muDoubleScalarSin(delta1);
        delta2 = muDoubleScalarCos(delta1);
        Bti.set_size(&p_emlrtRTEI, sp, 3, static_cast<int32_T>(spins));
        for (i1 = 0; i1 < loop_ub; i1++) {
          Bti[3 * i1] = 0.0;
          Bti[3 * i1 + 1] = 0.0;
          Bti[3 * i1 + 2] = 1.0 - E1;
        ...
        if (b_r.size(1) == Bti.size(1)) {
          M.set_size(&q_emlrtRTEI, sp, 3, b_r.size(1));
          ibtile = 3 * b_r.size(1);
          jtilecol = (ibtile / 2) << 1;
          vectorUB = jtilecol - 2;
          for (i1 = 0; i1 <= vectorUB; i1 += 2) {
        ...
        if (iEcho + 1 == 2) {
          // Rudy: run it twice to get to steady state
          ibtile = M.size(1);
          phirange.set_size(&r_emlrtRTEI, sp, 1, M.size(1));
          for (i1 = 0; i1 < ibtile; i1++) {
            phirange[i1] = M[3 * i1];
          }
          if (k + 1 > Mx.size(0)) {
            emlrtDynamicBoundsCheckR2012b(k + 1, 1, Mx.size(0), &k_emlrtBCI,
                                          (emlrtConstCTX)sp);
          }
          if (n + 1 > Mx.size(1)) {
            emlrtDynamicBoundsCheckR2012b(n + 1, 1, Mx.size(1), &l_emlrtBCI,
                                          (emlrtConstCTX)sp);
          }
          st.site = &h_emlrtRSI;
          Mx[k + Mx.size(0) * n] =
          ...
          if (k + 1 > My.size(0)) {
            emlrtDynamicBoundsCheckR2012b(k + 1, 1, My.size(0), &n_emlrtBCI,
                                          (emlrtConstCTX)sp);
          }
          if (n + 1 > My.size(1)) {
            emlrtDynamicBoundsCheckR2012b(n + 1, 1, My.size(1), &o_emlrtBCI,
                                          (emlrtConstCTX)sp);
          }
          st.site = &i_emlrtRSI;
          My[k + My.size(0) * n] =
          ...
          if (k + 1 > Mz.size(0)) {
            emlrtDynamicBoundsCheckR2012b(k + 1, 1, Mz.size(0), &p_emlrtBCI,
                                          (emlrtConstCTX)sp);
          }
          if (n + 1 > Mz.size(1)) {
            emlrtDynamicBoundsCheckR2012b(n + 1, 1, Mz.size(1), &q_emlrtBCI,
                                          (emlrtConstCTX)sp);
          }
          st.site = &j_emlrtRSI;
          Mz[k + Mz.size(0) * n] =
        ...
        //  M = zrot(phase(k))*M;
        if (k + 1 > tr.size(0)) {
          emlrtDynamicBoundsCheckR2012b(k + 1, 1, tr.size(0), &m_emlrtBCI,
                                        (emlrtConstCTX)sp);
        }
        delta2 = tr[k] - te;
        //
        ...
        nt = muDoubleScalarSin(delta1);
        delta2 = muDoubleScalarCos(delta1);
        Bti.set_size(&u_emlrtRTEI, sp, 3, static_cast<int32_T>(spins));
        for (i1 = 0; i1 < loop_ub; i1++) {
          Bti[3 * i1] = 0.0;
          Bti[3 * i1 + 1] = 0.0;
          Bti[3 * i1 + 2] = 1.0 - E1;
        ...
        if (b_r.size(1) == Bti.size(1)) {
          M.set_size(&v_emlrtRTEI, sp, 3, b_r.size(1));
          ibtile = 3 * b_r.size(1);
          jtilecol = (ibtile / 2) << 1;
          vectorUB = jtilecol - 2;
          for (i1 = 0; i1 <= vectorUB; i1 += 2) {
      ...
      // 	and off-resonance df.  Times in ms, off-resonance in Hz.
      //  Resonant precession, radians.
      Bti.set_size(&w_emlrtRTEI, sp, 3, static_cast<int32_T>(spins));
      for (i1 = 0; i1 < loop_ub; i1++) {
        Bti[3 * i1] = 0.0;
        Bti[3 * i1 + 1] = 0.0;
        Bti[3 * i1 + 2] = 1.0 - b_E1;
      ...
      if (M0.size(1) == Bti.size(1)) {
        ibtile = 3 * M0.size(1);
        M0.set_size(&x_emlrtRTEI, sp, 3, M0.size(1));
        jtilecol = (ibtile / 2) << 1;
        vectorUB = jtilecol - 2;
        for (i1 = 0; i1 <= vectorUB; i1 += 2) {
...
// End of code generation (dictionary_TRUEFISP_withRelaxDecay_opt.cpp)
