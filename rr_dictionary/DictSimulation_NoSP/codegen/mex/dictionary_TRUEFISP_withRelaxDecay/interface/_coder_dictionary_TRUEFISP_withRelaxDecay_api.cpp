...
//
// _coder_dictionary_TRUEFISP_withRelaxDecay_api.cpp
//
// Code generation for function '_coder_dictionary_TRUEFISP_withRelaxDecay_api'
//

// Include files
#include "_coder_dictionary_TRUEFISP_withRelaxDecay_api.h"
...
void c_dictionary_TRUEFISP_withRelax(const mxArray *const prhs[10],
                                     int32_T nlhs, const mxArray *plhs[3])
{
  ...
  te = emlrt_marshallIn(st, emlrtAlias(prhs[3]), "te");
  phase.no_free();
  emlrt_marshallIn(st, emlrtAlias(prhs[4]), "phase", phase);
  ti = b_emlrt_marshallIn(st, emlrtAliasP(prhs[5]), "ti");
  spins = b_emlrt_marshallIn(st, emlrtAliasP(prhs[6]), "spins");
  frames = b_emlrt_marshallIn(st, emlrtAliasP(prhs[7]), "frames");
  Inv = b_emlrt_marshallIn(st, emlrtAliasP(prhs[8]), "Inv");
  waitingDuration =
      b_emlrt_marshallIn(st, emlrtAliasP(prhs[9]), "waitingDuration");
  // Invoke the target function
  dictionary_TRUEFISP_withRelaxDecay(&st, r, flip, tr, *te, phase, ti, spins,
                                     frames, Inv, waitingDuration, Mx, My, Mz);
...
// End of code generation (_coder_dictionary_TRUEFISP_withRelaxDecay_api.cpp)
