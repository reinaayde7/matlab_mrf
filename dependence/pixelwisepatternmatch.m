...
% 
% Inputs:
%   imadapt: (1 x 1 x timepoints) MRF pixels
%   Jesus converted it to 1 x 1 to make it pixelwise
...
%          only 2 columns
%   dict: (timepoints x parameters) the MRF dictionary wirh T1 x T2 values
%   dimensions (without any extra dimension)
...
function [t1val,t2val,m0val] = patternmatch(imadapt,r,dict,nblocks)
...
for iblock=1:nblocks
    %     waitbar(iblock/nblocks,hw,'Pattern matching: Please wait');
