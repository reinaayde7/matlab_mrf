...
%%   June 04, 2013 - Normalized by sqrt(fftnumelements) instead of
%%   (fftnumelements)  -- Yun Jiang (yun.jiang@gmail.com)
function [newdata] = transformImageToKspace(data,dim,DCasFirstElement,NormalizeAsInV)
  ...
  if NormalizeAsInV,
    newdata = newdata/(sqrt(fftnumelements));% Yun Jiang - June 04, 2013
  end
  %----------------------------------------------------------------------
return